      ...
      <div
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" action="#">
            ...
            <button type="submit" class="w-full text-white bg-slate-400 hover:bg-slate-600 focus:ring-4 focus:outline-none 
            focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center
             dark:bg-primary-600 dark:hover:bg-primary-700 first-line:dark:focus:ring-primary-800">Sign in</button>
